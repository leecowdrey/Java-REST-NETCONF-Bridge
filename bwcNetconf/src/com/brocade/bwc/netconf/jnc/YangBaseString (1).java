 ...
 * <p>
 * White space collapse and replace methods, regexp pattern matchers, and length
 * assertion methods are provided.
 *
...
public class YangBaseString extends YangBaseType<String> {
     ...
     * @throws YangException If any regexp in regexes has a syntax error or does
     * not match.
     */
