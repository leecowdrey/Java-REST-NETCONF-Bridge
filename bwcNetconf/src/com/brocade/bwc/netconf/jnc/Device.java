...
/**
 * This class provides features for managing a device with NETCONF. A device has
 * a list of users {@link DeviceUser} which contain information about how to
...
public class Device implements Serializable {
    ...
    public void connect(String localUser, int connectTimeout)
        ...
        con = new SSHConnection(mgmt_ip, mgmt_port, connectTimeout, strictHostKeyCheck);
        auth(u);
    }
