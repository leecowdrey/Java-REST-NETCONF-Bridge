 ...
 *   </node>
 * <schema>
 * </pre> into a hashtable with {@link SchemaNode} elements.
 */
public class SchemaParser {
    ...
    /**
     * Scans the classpath for the XML schema file and populates the hashtable
     * with SchemaNode objects. Class is passed in so that in the case of
     * multiple {@link ClassLoader}s the correct one can be used to locate the
     * schema.
     *
     * @param filename
     * @param h
