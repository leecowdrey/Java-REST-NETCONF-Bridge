...
// LC: added getSchema, monitoringCapability, NS_NETCONF_YANG etc, CONFORMANCE
...
public class Capabilities {
    ...
    /**
     * String constant for the NETCONF base capability.
     * "urn:ietf:params:netconf:base:1.1". LC: added
     */
    public static final String NETCONF_BASE_CAPABILITY_11 = URN_IETF_PARAMS
            + "netconf:base:1.1";

    /**
     * The NETCONF YANG namespace "urn:ietf:params:xml:ns:yang:"
     */
    public static final String NS_NETCONF_YANG = "urn:ietf:params:xml:ns:yang:";

    /**
     * String constant for the <code>get-schema</code> capability.
     * "urn:ietf:params:xml:ns:yang:ietf-netconf-monitoring".
     */
    public static final String NS_MONITORING = NS_NETCONF_YANG
            + "ietf-netconf-monitoring";

    /**
     * String constant for the <code>get-schema-conformance</code> capability.
     * urn:ietf:params:xms:ns:yang:ietf-netconf-conformance".
     */
    public static final String CONFORMANCE_CAPABILITY = NS_NETCONF_YANG
            + "ietf-netconf-conformance";
     ...
     *
     * vyatta: urn:ietf:params:netconf:capability:xpath:1.0
     */
    ...
    protected boolean base11Capability = false;
    ...
    protected boolean monitoringCapability = false;
    ...
    protected boolean conformanceCapability = false;
    ...
    /**
     * Predicate for the <code>get-schema-conformance</code> capablity
     */
     ...
     * <li>deleteConfig - the &lt;delete-config&gt; operation can accept an URL,
     * then it should identify a local configuration file.
    ...
    public boolean hasXPath() {
        ...
        //LC: fix for vyatta - does not explicitly report xpath capability but is included so assume is part of 1.1 base
        return xpathCapability || base11Capability;
    }
    ...
    /**
     * Predicate for the <code>get-schema</code> capability.
     */
    ...
    public final ArrayList<Capa> capas;
    public final ArrayList<Capa> data_capas;
    ...
    protected Capabilities(Element e) throws JNCException {
        ...
        for (int i = 0; i < caps.size(); i++) {
            ...
            if (uri.equals(NETCONF_BASE_CAPABILITY)) {
                baseCapability = true;
            } else if (uri.equals(NETCONF_BASE_CAPABILITY_11)) {
                // LC: added
                baseCapability = true;
                base11Capability = true;
                // LC:added
                xpathCapability = true;
            } else if (uri.equals(NS_MONITORING)) {
                monitoringCapability = true;
            } else if (uri.equals(CONFORMANCE_CAPABILITY)) {
                conformanceCapability = true;
                ...
                baseCapability = true;
            } else if (uri.equals("urn:ietf:params:xml:ns:netconf:base:1.1")) {
                // LC: added
                baseCapability = true;
                base11Capability = true;
                // LC: added
