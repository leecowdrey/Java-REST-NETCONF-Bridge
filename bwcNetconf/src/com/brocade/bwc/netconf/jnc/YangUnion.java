 ...
 * different sub-types.
 * <p>
 * From RFC 6020: When a string representing a union data type is validated, the
 * string is validated against each member type, in the order they are specified
 * in the "type" statement, until a match is found. Any default value or "units"
 * property defined in the member types is not inherited by the union type.
 *
...
public class YangUnion extends YangBaseType<YangType<?>> {
     ...
     * @return true if obj is a a union with equal value and member types; false
     * otherwise.
     */
    @Override
