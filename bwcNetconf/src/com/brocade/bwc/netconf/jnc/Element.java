...
public class Element implements Serializable {
     ...
     * LC added
     *
     * The NETCONF YANG namespace.
     * "urn:ietf:params:xml:ns:yang:ietf-netconf-monitoring".
     */
    public static final String NETCONF_YANG_NAMESPACE = "urn:ietf:params:xml:ns:yang:ietf-netconf-monitoring";
    ...
    public static final PrefixMap defaultPrefixes = new PrefixMap(new Prefix[]{
        ...
        new Prefix("ncm", Capabilities.NS_MONITORING)});
     ...
     * {@link #CREATE_NEW}, {@link #CREATE_MERGE}, {@link #CREATE_MERGE_MULTI}
     * <p>
     * See {@link PathCreate} for more information about path create
     * expressions.
     *
    ...
    /**
     * Inserts a child element and returns the position of (the first occurrence
     * of) the inserted child in the list of children.
     * <p>
     * Checks that child is not already in use.
     *
     * @param child Child element to be inserted
     * @throws JNCException If child is already a child of another element or if
     * child equals this element
     */
     ...
     * @return <code>true</code> if any node matches pathStr; <code>false</code>
     * otherwise.
     */
    ...
    /**
     * Returns the value of a the first subnode matching a given path string, or
    ...
    /* Get */
    /**
     * Returns first node that matches the path expression, or <code>null</code>
    ...
    /**
     * clones the value to the target copy. Used in clone methods of this class
     * and YangElement.
     *
     ...
     * <code>removeAttr(Element.NETCONF_NAMESPACE,"operation");</code> see
     *
     * @removeAttr
     */
