...
public class JNCException extends Exception {
     ...
     * to Client code. A revision error occurs when we try to encode something
     * the receiving node doesn't understand, such as an unknown enumeration or
     * bit value.
     */
     ...
     *
     */
    public static final int MODULE_SCHEMA_NOT_FOUND = -14;

    /**
     * LC added
     *
     */
    public static final int SSH_TARGET_NOT_AVAILABLE = -15;

    /**
     * LC added
     *
     */
    public static final int SSH_HOSTKEY_INVALID = -16;

    /**
     * LC added
     *
     */
    public static final int MODULE_DEFINITION_INVALID = -17;

    /**
     * LC added
     *
     */
    public static final int SUBMODULE_DEFINITION_INVALID = -18;
    ...
    public String toString() {
        switch (errorCode) {
            ...
            case MODULE_SCHEMA_NOT_FOUND:
                return "Module definition not available: " + opaqueData;
            case SSH_TARGET_NOT_AVAILABLE:
                return "SSH target not available: " + opaqueData;
            case SSH_HOSTKEY_INVALID:
                return "SSH hostkey invalid: " + opaqueData;
            case MODULE_DEFINITION_INVALID:
                return "YANG module invalid: " + opaqueData;
            case SUBMODULE_DEFINITION_INVALID:
                return "YANG submodule invalid: " + opaqueData;
            default:
