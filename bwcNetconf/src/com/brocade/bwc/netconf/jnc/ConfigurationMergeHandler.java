...
public class ConfigurationMergeHandler {
    ...
    /**
     * Updates a master configuration by merging a configuration fragment into
     * it.
     *
     * @param masterConfiguration the configuration to be updated
     * @param configurationFragment contains the elements to be used to update
     * the configuration
     * @param xPath contains an XPath definition of the element(s) to be updated
     * @return the <code>masterConfiguration</code> NodeSet with the elements
     * defined by <code>xPath</code> updated from corresponding elements in
     * <code>configurationFragment</code>
     */
